...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "E-Commerce Taboola pixel (beta)",
  "brand": {
    "id": "brand_dummy",
    "displayName": "Taboola",
  ...
  "description": "Use the Taboola E-Commerce Pixel template to enable Taboola automatically personalize your campaigns towards people who visited your website",
  "categories": [
    "MARKETING",
    "CONVERSION_TRACKING",
    "ADVERTISING"
